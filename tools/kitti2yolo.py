...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--images_dir", type=str,  help="D:\tmp\vehicle-detection-yolov8-main\data\kitti\images"
    )
    parser.add_argument(
        "--labels_dir", type=str,  help="D:\tmp\vehicle-detection-yolov8-main\data\kitti\label_2"
    )
    parser.add_argument(
        "--output_dir", type=str,  help="D:\tmp\vehicle-detection-yolov8-main\data\kitti"
    )
